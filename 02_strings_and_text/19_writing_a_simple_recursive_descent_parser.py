...
# Parsing text according to a set of grammar rules and performing actions or
# build an abstract syntax tree representing the input.
NUM = r'(?P<NUM>\d+)'
PLUS = r'(?P<PLUS>\+)'
MINUS = r'(?P<MINUS>-)'
TIMES = r'(?P<TIMES>\*)'
...
class ExpressionEvaluator:
    ...
    and discard the next token on on the input (or raise a SyntaxError if
    it doesn't match).
    '''
...
# tools such as PyParsing or PLY.
